...
# Database: adres_NG_test
# Generation Time: 2011-04-03 11:45:42 +0200
# ************************************************************
...
INSERT INTO `affiliations` (`id`,`contact_type_father_id`,`contact_type_child_id`,`father_name`,`child_name`,`created`,`modified`)
VALUES
...
LOCK TABLES `affiliations_contacts` WRITE;
/*!40000 ALTER TABLE `affiliations_contacts` DISABLE KEYS */;
INSERT INTO `affiliations_contacts` (`id`,`affiliation_id`,`contact_father_id`,`contact_child_id`,`after_id`)
VALUES
	(1,1,1,3,0),
	(2,5,1,7,0),
	(3,1,3,10,0),
...
/*!40000 ALTER TABLE `affiliations_contacts` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `contact_types` (
  ...
  CONSTRAINT `fk_contact_types_implementations` FOREIGN KEY (`implementation_id`) REFERENCES `implementations` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `contacts` (
  ...
  CONSTRAINT `fk_contacts_contact_types` FOREIGN KEY (`contact_type_id`) REFERENCES `contact_types` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

LOCK TABLES `contacts` WRITE;
/*!40000 ALTER TABLE `contacts` DISABLE KEYS */;
INSERT INTO `contacts` (`id`,`contact_type_id`,`trash_id`)
VALUES
	(1,5,0),
	(2,5,0),
	(3,5,0),
...
INSERT INTO `contacts_groups` (`id`,`contact_id`,`group_id`)
VALUES
	(42,1,2),
	(44,1,15),
	(40,2,2),
...
CREATE TABLE `fields` (
  ...
  CONSTRAINT `fk_fields_contact_types` FOREIGN KEY (`contact_type_id`) REFERENCES `contact_types` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_fields_field_types` FOREIGN KEY (`field_type_class_name`) REFERENCES `field_types` (`class_name`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=latin1;

LOCK TABLES `fields` WRITE;
/*!40000 ALTER TABLE `fields` DISABLE KEYS */;
INSERT INTO `fields` (`id`,`name`,`contact_type_id`,`order`,`field_type_class_name`,`is_descriptive`,`required`)
VALUES
...
CREATE TABLE `filters` (
  ...
  CONSTRAINT `fk_filters_contact_types` FOREIGN KEY (`contact_type_id`) REFERENCES `contact_types` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `groups` (`id`,`name`,`parent_id`,`lft`,`rght`,`contact_type_id`,`created`,`modified`)
VALUES
...
INSERT INTO `hidden_fields` (`id`,`user_id`,`contact_type_id`,`field_id`)
VALUES
	(3,1,8,21);
...
CREATE TABLE `logs` (
  ...
  CONSTRAINT `fk_logs_contacts` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=91 DEFAULT CHARSET=latin1;

LOCK TABLES `logs` WRITE;
/*!40000 ALTER TABLE `logs` DISABLE KEYS */;
INSERT INTO `logs` (`id`,`log_dt`,`description`,`contact_id`,`user_id`)
VALUES
...
CREATE TABLE `trashes` (
  ...
  CONSTRAINT `fk_trashes_contacts` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `type_boolean` (
  ...
  CONSTRAINT `fk_type_boolean_contacts` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_type_boolean_fields` FOREIGN KEY (`field_id`) REFERENCES `fields` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `type_boolean` WRITE;
/*!40000 ALTER TABLE `type_boolean` DISABLE KEYS */;
INSERT INTO `type_boolean` (`field_id`,`contact_id`,`data`)
VALUES
	(14,22,0),
	(24,23,0),
	(14,24,1),
...
/*!40000 ALTER TABLE `type_boolean` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `type_date` (
  ...
  CONSTRAINT `fk_type_date_contacts` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_type_date_fields` FOREIGN KEY (`field_id`) REFERENCES `fields` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `type_date` WRITE;
/*!40000 ALTER TABLE `type_date` DISABLE KEYS */;
INSERT INTO `type_date` (`field_id`,`contact_id`,`data`)
VALUES
...
CREATE TABLE `type_date_options` (
  ...
  CONSTRAINT `fk_type_date_options` FOREIGN KEY (`field_id`) REFERENCES `fields` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

LOCK TABLES `type_date_options` WRITE;
/*!40000 ALTER TABLE `type_date_options` DISABLE KEYS */;
INSERT INTO `type_date_options` (`id`,`contact_type_id`,`field_id`,`format`,`selected`)
VALUES
	(1,5,12,'timeAgoInWords',1),
	(2,5,22,'age',0);

/*!40000 ALTER TABLE `type_date_options` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `type_email` (
  ...
  CONSTRAINT `fk_type_email_contacts` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_type_email_fields` FOREIGN KEY (`field_id`) REFERENCES `fields` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `type_email` WRITE;
/*!40000 ALTER TABLE `type_email` DISABLE KEYS */;
INSERT INTO `type_email` (`field_id`,`contact_id`,`data`)
VALUES
...
CREATE TABLE `type_integer` (
  ...
  CONSTRAINT `fk_type_integer_contacts` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_type_integer_fields` FOREIGN KEY (`field_id`) REFERENCES `fields` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `type_integer` WRITE;
/*!40000 ALTER TABLE `type_integer` DISABLE KEYS */;
INSERT INTO `type_integer` (`field_id`,`contact_id`,`data`)
VALUES
	(5,1,30),
	(5,2,50),
	(5,3,29),
...
/*!40000 ALTER TABLE `type_integer` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `type_select` (
  ...
  CONSTRAINT `fk_type_select_contacts` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_type_select_fields` FOREIGN KEY (`field_id`) REFERENCES `fields` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `type_select` WRITE;
/*!40000 ALTER TABLE `type_select` DISABLE KEYS */;
INSERT INTO `type_select` (`contact_id`,`field_id`,`data`)
VALUES
	(1,19,0),
	(3,19,0),
	(8,19,0),
...
/*!40000 ALTER TABLE `type_select` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `type_select_options` (
  ...
  CONSTRAINT `fk_type_select_options_fields` FOREIGN KEY (`field_id`) REFERENCES `fields` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=latin1;

LOCK TABLES `type_select_options` WRITE;
/*!40000 ALTER TABLE `type_select_options` DISABLE KEYS */;
INSERT INTO `type_select_options` (`id`,`contact_type_id`,`field_id`,`value`)
VALUES
	(12,5,19,'Guitar'),
	(13,5,19,'Keybord'),
	(14,5,19,'Cycles'),
...
/*!40000 ALTER TABLE `type_select_options` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `type_string` (
  ...
  CONSTRAINT `fk_type_string_contacts` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_type_string_fields` FOREIGN KEY (`field_id`) REFERENCES `fields` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `type_string` WRITE;
/*!40000 ALTER TABLE `type_string` DISABLE KEYS */;
INSERT INTO `type_string` (`field_id`,`contact_id`,`data`)
VALUES
	(3,1,'Rajib'),
	(3,2,'John'),
	(3,3,'Jonathan'),
...
/*!40000 ALTER TABLE `type_string` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `type_text` (
  ...
  CONSTRAINT `fk_field_id` FOREIGN KEY (`field_id`) REFERENCES `fields` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_type_text_contacts` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `type_text` WRITE;
/*!40000 ALTER TABLE `type_text` DISABLE KEYS */;
INSERT INTO `type_text` (`contact_id`,`field_id`,`data`)
VALUES
	(23,25,''),
...
/*!40000 ALTER TABLE `type_text` ENABLE KEYS */;
UNLOCK TABLES;
