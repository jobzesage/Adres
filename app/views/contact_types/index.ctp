...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $html->link(__('Edit', true), array('action' => 'edit', $contactType['ContactType']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action' => 'delete', $contactType['ContactType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $contactType['ContactType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
